    ...
    body: `
      <div>
        ...
        <div class="project">
          ...
          <p>A REST API for managing carts built with NestJS, featuring JWT authentication and route guards for user verification. The API also utilizes bcrypt for password hashing, ensuring secure user authentication and authorization before granting access to protected routes.</p>
